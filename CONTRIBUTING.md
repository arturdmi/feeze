...
[Feeze Code of Conduct](https://github.com/tokiwa-software/feeze/blob/main/CODE_OF_CONDUCT.md).
...
- Open an [Issue](https://github.com/tokiwa-software/feeze/issues/new).
...
> A checkbox to agree to the [Tokiwa Software Feeze Contributor Agreement](https://github.com/tokiwa-software/feeze/blob/main/CONTRIBUTOR_LICENSE_AGREEMENT.md) will automatically be added to the text describing your pull request. You will have to accept this agreement.
> Please make sure that your identity is known to the the Feeze team.  In case you prefer to use an anonymous account for your contribution, make sure your identity is known to the Feeze team by sending an email to <info@tokiwa.software>.
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://github.com/tokiwa-software/feeze/issues/README.md). If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/tokiwa-software/feeze/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/tokiwa-software/feeze/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
This section guides you through submitting an enhancement suggestion for Feeze, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.

<!-- omit in toc -->
#### Before Submitting an Enhancement

- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/tokiwa-software/feeze/issues/README.md) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/tokiwa-software/feeze/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset. If you're just targeting a minority of users, consider writing an add-on/plugin library.

<!-- omit in toc -->
#### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/tokiwa-software/feeze/issues).
...
- **Explain why this enhancement would be useful** to most Feeze users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
...
The first line of a commit message should describe the part of Feeze that is
